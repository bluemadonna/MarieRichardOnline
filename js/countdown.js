// ===================================================
// countdown.js — обратный отсчёт до тура в реальном времени.
//
// Чтобы поменять дату/название события — отредактируй
// строки ниже. Формат даты: "ГГГГ-ММ-ДДTЧЧ:ММ:СС"
// ===================================================

var TOUR_DATE = "2001-09-15T19:00:00";
